...
public class AutoFitGridLayout extends ViewGroup {
    ...
    public void setOnClickListener(OnClickListener onClickListener){
        if(notGoneViewList == null) refreshNotGoneChildList();
        for(View v : notGoneViewList){
            if(v.hasOnClickListeners()) continue;
    ...
    public void refreshNotGoneChildList() {
        ...
        for (int i = 0; i < line; i++) {
            ...
            for (int j = 0; j < columnCount; j++) {
                ...
                if (childIndex < childCount) {
                    ...
                    if(childCount %2 != 0 && childIndex == childCount-1){
                        childWidthWithPadding = getMeasuredWidth();
                    }
